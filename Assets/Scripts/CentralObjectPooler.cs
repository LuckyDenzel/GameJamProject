...
namespace LuckyGamezLib {
    public class CentralObjectPooler : MonoBehaviour {
        ...
        public static CentralObjectPooler Instance { get; private set; }
        ...
        public void CreateNewPool(string poolId, GameObject objectPrefab, int amountToSpawn) {
            ...
            for (int i = 1; i < amountToSpawn; i++) {
                ...
                GameObject instantiatedObject = Object.Instantiate(objectPrefab, Vector3.zero, Quaternion.identity);

                // Set the object inactive so that it isn't visible in-game
                instantiatedObject.SetActive(false);

                // Enqueue the object to later use
                objectPoolQueue.Enqueue(instantiatedObject);
            }
